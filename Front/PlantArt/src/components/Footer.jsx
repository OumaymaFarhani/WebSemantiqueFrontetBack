...
export const Footer = () => {
    return (
        <Container>
        <Left>
        <Logo><Image src="plantartlogo.png"  /> PlantArt</Logo>
        <Desc>
      ...
      <Right>
        <Title>Contact</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> Tunis,Ariana 
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> +21655505555
        </ContactItem>
        <ContactItem>
          <MailOutline style={{marginRight:"10px"}} /> runtime.terror@gmail.com
        </ContactItem>
